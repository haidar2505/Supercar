...
<body>
    ...
    <!--  -->
    <h1 class="mt-5 mb-5 text-center" style="font-family: Bebas Neue, sans-serif; font-size: 80px;">Ferrari</h1>
    <?php
        include("../Database/connexion.php");
        $section2 = "SELECT * FROM voiture WHERE Id_marque = 2;";
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body position-relative">
                    ...
                    <a href="ferrari.php" style="font-family: Poppins, sans-serif;"><button type="submit" class="btn btn-secondary w-25 position-absolute bottom-0 end-0">Close</button></a>
                </div>
            </div>
        </div>
    </div>
